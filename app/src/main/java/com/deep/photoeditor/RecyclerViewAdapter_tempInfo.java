...
public class RecyclerViewAdapter_tempInfo extends RecyclerView.Adapter<RecyclerViewAdapter_tempInfo.MyViewHolder> {
    Context mContext;
    List<TempInfo> mData;

    public RecyclerViewAdapter_tempInfo(Context mContext, List<TempInfo> mData) {
