...
import com.deep.photoeditor.fragment.ColEldFragment;
import com.wx.goodview.GoodView;

public class ColEldActivity extends AppCompatActivity {
    private static final String TAG = "ColEldActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //新增回到前一頁的箭頭
        getSupportActionBar().setTitle("收藏長輩圖"+"("+cnt+")");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        viewPager = (ViewPager)findViewById(R.id.colEldViewPager);
        pagerAdapter = new PageAdapter(getSupportFragmentManager());

        //Add Fragment here
        pagerAdapter.AddFragment(new ColEldFragment(),"相關長輩圖");
