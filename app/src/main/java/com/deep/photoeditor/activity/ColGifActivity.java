...
import com.deep.photoeditor.fragment.ColGifFragment;
import com.wx.goodview.GoodView;

public class ColGifActivity extends AppCompatActivity {
    private static final String TAG = "ColGifActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Add Fragment here
        pagerAdapter.AddFragment(new ColGifFragment(),"相關動圖");
