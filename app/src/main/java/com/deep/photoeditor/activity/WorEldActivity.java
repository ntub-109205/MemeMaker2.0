...
import com.deep.photoeditor.fragment.WorEldFragment;
import com.deep.photoeditor.fragment.WorMemeFragment;
import com.wx.goodview.GoodView;

public class WorEldActivity extends AppCompatActivity {
    private static final String TAG = "WorEldActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wor_eld);
        ...
        //新增回到前一頁的箭頭
        getSupportActionBar().setTitle("我的長輩圖"+"("+cnt+")");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        viewPager = (ViewPager)findViewById(R.id.worEldViewPager);
        pagerAdapter = new PageAdapter(getSupportFragmentManager());

        //Add Fragment here
        pagerAdapter.AddFragment(new WorEldFragment(),"相關長輩圖");
