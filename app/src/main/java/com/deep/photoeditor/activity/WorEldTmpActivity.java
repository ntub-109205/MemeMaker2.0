...
import com.deep.photoeditor.fragment.WorEldTmpFragment;
import com.deep.photoeditor.fragment.WorMemeTmpFragment;
import com.wx.goodview.GoodView;

public class WorEldTmpActivity extends AppCompatActivity {
    private static final String TAG = "WorEldTmpActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //新增回到前一頁的箭頭
        getSupportActionBar().setTitle("我的長輩圖模板"+"("+cnt+")");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        viewPager = (ViewPager)findViewById(R.id.worEldTmpViewPager);
        pagerAdapter = new PageAdapter(getSupportFragmentManager());

        //Add Fragment here
        pagerAdapter.AddFragment(new WorEldTmpFragment(),"相關長輩圖");
