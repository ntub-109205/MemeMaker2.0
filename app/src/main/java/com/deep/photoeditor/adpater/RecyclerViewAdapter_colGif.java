...
public class RecyclerViewAdapter_colGif extends RecyclerView.Adapter<RecyclerViewAdapter_colGif.MyViewHolder> {
    Context mContext;
    List<PublicMeme> mData;


    public RecyclerViewAdapter_colGif(Context mContext, List<PublicMeme>  mData) {
