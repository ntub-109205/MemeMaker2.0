...
public class RecyclerViewAdapter_worGif extends RecyclerView.Adapter<RecyclerViewAdapter_worGif.MyViewHolder> {
    Context mContext;
    List<WorPublicMeme> mData;
    private static api callApi = new api();

    public RecyclerViewAdapter_worGif(Context mContext, List<WorPublicMeme> mData) {
